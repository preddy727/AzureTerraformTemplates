...
variable "name_prefix" {
   ...
   description = " The name of the resource group where the cicd infrastructure resides" 
   type = "string"
...
variable "shared_image_resource_group" {
  ...
  description = "The name of the shared image resource group"

}

variable "shared_image_version" {

  description = "The version number of the shared Image. Example is 1.0.0"
