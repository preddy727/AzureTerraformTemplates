...
variable "image_gallery_location" {
  description = "The location where the resources will be created"
  default = "__image_gallery_location__"
}
